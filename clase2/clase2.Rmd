...
---
background-image: url(clase8_files/Comunicaciones_udd.png)
background-size: 150px
background-position: 97% 97%
class: left, top
...
## Ejemplo: encuesta a estudiantes de perriodismo
...
$$n= \frac{7600 * 1.96^2* 0.5 *(1-0.5)}{0.05^2(7600 - 1) + 1.96^* 0.5(1-0.5)}$$
---
...
```{r, out.width="80%", fig.align='center'}
knitr::include_graphics("https://www.researchgate.net/profile/Carlos-Manterola-2/publication/316298141/figure/fig7/AS:506944012996608@1497876279047/Muestreo-por-conglomerados-Se-seleccionan-al-azar-una-muestra-de-4-consultorios-de-salud.png")
```
...
## Ejemplo: conglomerados para encuesta en las condes

estimación: 2100 manzanas en las condes, repartidas en 16 unidades vecinales.
