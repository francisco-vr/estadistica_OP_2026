...
---
Cosas importantes del ejercicio:

1. Escribir la fórmula con los valores reales
2. Mostrar el desarrollo del ejercicio hasta obtener el resultado
4. Escribir el resultado final con palabras
...
```
---
## Ensayo final de control:

La Municipalidad de Providencia desea realizar una encuesta a los vecinos de la comuna para conocer su satisfacción con los servicios municipales. Se sabe que la comuna tiene 12.840 vecinos registrados.

¿Cuántos vecinos se debe encuestar para obtener una muestra representativa bajo muestreo aleatorio simple?

---
Extra: La Municipalidad quiere resultados más precisos y solicita recalcular la muestra con un 99% de confianza en vez de 95%. Indique el nuevo tamaño muestral y explique brevemente los beneficios y desafíos de usar este nivel de confianza.


---

Pregunta 2 — Medidas descriptivas

El podcast chileno Tomás va a morir registró los siguientes números de comentarios en 8 episodios de su canal de YouTube:

 B = [716 ; 367 ; 671 ; 525 ; 249 ; 386 ; 465 ; 568] 
 

Con esta lista de valores calcule:
